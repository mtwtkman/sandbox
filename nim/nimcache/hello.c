...
/* Command for C compiler:
   gcc -c  -w  -I/opt/Nim/lib -o /source/nimcache/hello.o /source/nimcache/hello.c */
...
static N_NIMCALL(void, T_xLHv575t3PG1lB5wK05Xqg_3)(void);
...
STRING_LITERAL(T_xLHv575t3PG1lB5wK05Xqg_2, "What\'s your name? ", 18);
STRING_LITERAL(T_xLHv575t3PG1lB5wK05Xqg_4, "Hi, ", 4);
STRING_LITERAL(T_xLHv575t3PG1lB5wK05Xqg_5, "!", 1);
static N_NIMCALL(void, T_xLHv575t3PG1lB5wK05Xqg_3)(void) {
...
nimRegisterGlobalMarker(T_xLHv575t3PG1lB5wK05Xqg_3);
	nimln(1, "hello.nim");
	printf("%s\012", ((NimStringDesc*) &T_xLHv575t3PG1lB5wK05Xqg_2)? (((NimStringDesc*) &T_xLHv575t3PG1lB5wK05Xqg_2))->data:"nil");
	fflush(stdout);
	nimln(2, "hello.nim");
	asgnRefNoCycle((void**) (&name_dMTGZKFzGbeaiYQJt5qMZQ), readline_fPRnXwDTqtynUYGl4OixAg(stdin));
	nimln(3, "hello.nim");
	printf("%s%s%s\012", ((NimStringDesc*) &T_xLHv575t3PG1lB5wK05Xqg_4)? (((NimStringDesc*) &T_xLHv575t3PG1lB5wK05Xqg_4))->data:"nil", name_dMTGZKFzGbeaiYQJt5qMZQ? (name_dMTGZKFzGbeaiYQJt5qMZQ)->data:"nil", ((NimStringDesc*) &T_xLHv575t3PG1lB5wK05Xqg_5)? (((NimStringDesc*) &T_xLHv575t3PG1lB5wK05Xqg_5))->data:"nil");
	fflush(stdout);
	popFrame();
}
